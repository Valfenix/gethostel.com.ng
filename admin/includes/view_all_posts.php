      ...
      <table class="table table-bordered table-hover">
            ...
            <div class="col-xs-4">
                ...
                <a class="btn btn-primary" href="posts.php?source=add_post">Add New</a>
                            ...
                            $query = "SELECT * FROM post_categories WHERE cat_id = {$post_category_id} ";
                            ...
                            echo "<td><img width='100' src='../images/blog/$post_image' alt='image'></td>";
                            ...
                            echo "<td><a class='btn btn-primary' href='../blog.php?p_id={$post_id}'>View Post</a></td>";
